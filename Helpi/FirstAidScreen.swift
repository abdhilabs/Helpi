...
class FirstAidScreen: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  ...
  let firstAid: [FirstAid] = [
    FirstAid(image: "screen1", title: "Ensure Surrounding is Safe", description: "- Ensure that I am in a safe and not in a crowded area \n - Make sure that I have plenty of fresh air \n - Ask other people to move away "),
    FirstAid(image: "screen2", title: "Lay Me Down", description: "- Lay me down \n - ook for my response by loudly calling my name or squeezing my shoulder"),
    FirstAid(image: "screen3", title: "Clean Air Way", description: "- Check my mouth and throat \n - Remove any obvious blockages in the mouth or nose, such as vomit, blood, etc."),
    FirstAid(image: "screen4", title: "Call Emergency", description: "- if my condition is getting worse, please call my emergency contact or call nearby emergency number")]
