...
class FirstAidScreen: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  ...
  let firstAid: [FirstAid] = [
    FirstAid(title: "Pastikan Keadaan Sekitar Aman", guide: [.init(image: "firstaid1_gambar1", description: "Pastikan saya aman dan tidak di tempat ramai"), .init(image: "firstaid1_gambar2", description: "Pastikan saya punya banyak udara segar"), .init(image: "firstaid1_gambar3", description: "Minta orang lain tidak berkerumun")])
  ]
